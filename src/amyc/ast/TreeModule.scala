...
trait TreeModule {
  ...
  case class ParamDef(name: Name, tpe: TypeTree) extends Definition
  ...
  // This is a utility for type checking and is compatible with any type.
  // No value in the program can have this type.
